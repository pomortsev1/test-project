...
export default async function LocalizedTemplatesLayout({
  children,
  params,
}: Readonly<{
  children: ReactNode;
  ...
  await requireCurrentUserId(getLocalizedPathname("/templates", locale));
      ...
      <main className="mx-auto flex min-h-screen w-full max-w-7xl flex-col gap-8 px-6 py-8 sm:px-8 lg:px-10 lg:py-10">
        <section className="space-y-2">
          ...
          <h1 className="max-w-4xl text-4xl font-semibold tracking-tight text-balance sm:text-5xl">
            {t("Open your default list and edit it fast.")}
          </h1>
